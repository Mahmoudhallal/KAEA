...
save(topTables_less, file=paste0(params$CWD,"/results/",params$cell_line,'_',params$pvalue_cutoff,'P_',params$fdr_cutoff,'FDR/',"topTables_",params$cell_line,"_less.Rda"))
save(topTables_greater, file=paste0(params$CWD,"/results/",params$cell_line,'_',params$pvalue_cutoff,'P_',params$fdr_cutoff,'FDR/',"topTables_",params$cell_line,"_greater.Rda"))
